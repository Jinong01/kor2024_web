...
public class Main {
    public static void main(String[] args) {
        ...
        // === 단(한쪽에서만 참조 중)방향 연관관계, PK-FK 관계, 1:N 관계
        ...
        // 생성자는 순서가 틀리면 오류가 나고 빼먹어도 오류가 난다.
        ...
        // 4. 회원 객체의 게시물 확인, 게시물 객체는 회원객체를 참조하지만 회원객체는 게시물객체를 참조하지 않는다.

        // === 양방향(서로 참조) 연관관계, 데이터베이스에서는 표현 불가능하다

        // 5. 양방향 설정, 회원 객체에서 게시물 객체 대입
        m1.get작성한게시물().add(b1);
    }
}
